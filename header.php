<head>
		...
		<title>Guide.Me (An Intelligent Career Guidance Counselor)</title>
			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a class="logo" href="index.php">Guide.Me</a>
					</div>
					<!-- /Logo -->
					...
					<ul class="main-menu nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-content">
								<a href="http://127.0.0.1/Guide.Me/login.php">Career Prediction</a>
								<a href="quiz.php" >Quiz & personality</a>

                                <a href="http://127.0.0.1/Guide.me/courses.php">Courses</a>
                                <a href="http://127.0.0.1/Guide.Me/blog.php">Knowledge Network</a>
					...
					<ul class="main-menu nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-content">
								...
								<a href ="quiz.php">Quiz.personality Test</a>
