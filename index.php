				...
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							...
							margin-bottom:50px;">Virtual Career Counseling Platform</h1>
							
							<?php
								// Check if the user is logged in, if not then redirect him to login page
								if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true):?>
									<p class="lead white-text" style="margin-left: 5px;" ><b>Discover yourself<br>Take the test to find the perfect role for you after high school</b></p>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to Guide.Me</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">Guide.Me</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
				...
				<div class="row">
					...
					<!-- /feature -->
						...
						<i class="feature-icon fa "><span>&#x1F50E;&#xFE0E;</span></i>
							<div class="feature-content">
								<a href="quiz.php" >
								<h4>Quiz & personality</h4>
								</a>
								<p>Take the quiz to know more about what interests you!</p>
							</div>
						</div>
					</div>
					<!-- /feature -->
					...
					<div class="col-md-3">
						...
						<i class="feature-icon fa "><span>&#x1F50E;&#xFE0E;</span></i>
							<div class="feature-content">
								...
								<p>Gain knowledge through various sources, and access to study materials, etc.</p>
							</div>
						</div>
					</div>
					<!-- /feature -->
